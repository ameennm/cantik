            ...
            <div className="footer-container">
                <div className="footer-grid">
                    ...
                    <div className="footer-brand">
                        ...
                        <p className="footer-description">
                            Discover beautiful women's dresses, ethnic wear, party gowns, and more.
                    ...
                    <div className="footer-section">
                        ...
                        <nav className="footer-nav">
                            ...
                            <Link to="/shop?category=Ethnic">Ethnic</Link>
                    ...
                    <div className="footer-section">
                        ...
                        <div className="footer-contact">
                            ...
                            <p className="footer-email">info@cantik.com</p>
                        </div>
                        <div className="footer-social">
                            ...
                            <a href="#" className="social-link" aria-label="Pinterest">
                                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                                    ...
                                    <path d="M8 12c0-3 2-5 4-5s4 2 4 5c0 3-2 5-4 7" />
                ...
                <div className="footer-bottom">
                    <p className="footer-copyright">
                        © {currentYear} Cantik. All rights reserved.
                    </p>
